...
body IsisSession::get_stats {} {
    ...
    set session_conf            [ lsearch -exact $captionList {L2 Sess. Configured} ]
    set session_succ            [ lsearch -exact $captionList {L2 Sess. Up} ]
    set flap         	        [ lsearch -exact $captionList {L2 Session Flap Count} ]
