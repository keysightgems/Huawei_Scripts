...
class Ospfv2Session {
    ...
    constructor { port { hOspfSession NULL } } { chain $port $hOspfSession } {
        ...
        Deputs "----- hOspfSessionwaseem: $hOspfSession, hPort: $hPort, portObj is: $portObj, port is: $port -----"
        if { $hOspfSession != "NULL" } {
...
Deputs "----- TAG: $tag -----"
        ...
        #ixNet setA $hPort/protocols/ospf -active True
        #ixNet setA $ospfObj -active True
        #ixNet commit
		if {0} {
